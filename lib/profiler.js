...
function Profiler () {
	...
	function speed(fn, args, reps) {
		...
		console.log('average execution time:', Math.floor(averageTime / 1000).toFixed(2), 'seconds');
		console.log('total time:', Math.floor((+new Date() - trueStartTime) / 1000).toFixed(2), 'seconds');
	}
